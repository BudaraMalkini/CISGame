 ...
 * @author User
 */
public class Game7 extends javax.swing.JFrame {
        ...
        this.TI = new Timer(1000, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (i == 0) {
                    ...
                    Answer ans2 = new Answer(7, "Over Due");
                    TempanswerService anssv2 = new TempanswerService();
                    anssv2.saveProAnswer(7, ans2);
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/q6.png"))); // NOI18N
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(1094, 14, 170, 90));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        jLabel4.setText("Answer:");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 680, 170, 40));
        ...
        jPanel1.add(txtAnswerProvided, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 670, 230, 50));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1110, 670, 130, 50));
        ...
        jPanel1.add(Timer, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 20, 310, 90));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!(answer.isEmpty() || answer.equals(null))) {
            if (answer.equals("3")) {//question ake answer eka 
                ans1 = new Answer(7, "True");
            } else {
                ans1 = new Answer(7, "False");
            }
        } else {
            ans1 = new Answer(7, "Skipped");
        }

        TempanswerService ansSv = new TempanswerService();
        ansSv.saveProAnswer(7, ans1);
        new Game8().setVisible(true);
        TI.stop();
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Game7.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
