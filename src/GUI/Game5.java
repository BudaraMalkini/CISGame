...
public class Game5 extends javax.swing.JFrame {
        ...
        this.TI = new Timer(1000, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (i == 0) {
                    ...
                    Answer ans2 = new Answer(5, "Over Due");
                    TempanswerService anssv2 = new TempanswerService();
                    anssv2.saveProAnswer(5, ans2);
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/q5_1.png"))); // NOI18N
        jLabel1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 120, 900, 500));

        logo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/qlogo.png"))); // NOI18N
        jPanel1.add(logo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 300, 120));
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1080, 10, 180, 50));
        ...
        jPanel1.add(level1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 320, 170, 100));
        ...
        jPanel1.add(Timer, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 20, 290, 90));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!(answer.isEmpty() || answer.equals(null))) {
            if (answer.equals("50")) {//question ake answer eka 
                ans1 = new Answer(5, "True");
            } else {
                ans1 = new Answer(5, "False");
            }
        } else {
            ans1 = new Answer(5, "Skipped");
        }

        TempanswerService ansSv = new TempanswerService();
        ansSv.saveProAnswer(5, ans1);
